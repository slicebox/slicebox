...
class AnonymizationDAO(val dbConf: DatabaseConfig[JdbcProfile])(implicit ec: ExecutionContext) {
  ...
  class AnonymizationKeyTable(tag: Tag) extends Table[AnonymizationKey](tag, AnonymizationKeyTable.name) {
    ...
    def patientID = column[String](DicomProperty.PatientID.name, O.Length(64))
    def anonPatientID = column[String]("anonPatientID", O.Length(64))
    def studyInstanceUID = column[String](DicomProperty.StudyInstanceUID.name, O.Length(128))
    def anonStudyInstanceUID = column[String]("anonStudyInstanceUID", O.Length(128))
    def seriesInstanceUID = column[String](DicomProperty.SeriesInstanceUID.name, O.Length(128))
    def anonSeriesInstanceUID = column[String]("anonSeriesInstanceUID", O.Length(128))
    def sopInstanceUID = column[String](DicomProperty.SOPInstanceUID.name, O.Length(128))
    def anonSOPInstanceUID = column[String]("anonSOPInstanceUID", O.Length(128))
